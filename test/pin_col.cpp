...
int main(int /*argc*/, char ** /*argv*/) {
  ...
  pinocchio::srdf::loadReferenceConfigurations(
      model, srdf_filename); // the reference configuratio stored in the SRDF
                             // file is called half_sitting
  ...
  // If you want to stop as soon as a collision is encounter, just add false for
  // the final default argument stopAtFirstCollision
