...
class _NonLeafNodeTrait(_Node):
    ...
    def balance_children(self, the_child, mtree):
        ...
        if nearest_donor is None:
            # Merge
            for grandchild in the_child.children.values():
                distance = mtree.distance_function(
                    grandchild.data, nearest_merge_candidate.data
                )
            ...
            for grandchild in nearest_donor.children.values():
